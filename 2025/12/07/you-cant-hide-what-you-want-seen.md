...
Like this: {::nomarkdown}<style>span.ms2e0ooczb2ligskj-tt1tzt3j5krfh7vr { display: inline-block; }</style><script>(function(){function uhsseen4hmx6t7(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function frd9ou8an6(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var crhodiwawke=sp.getAttribute('data-f2h9yjm8i1l');var fxs7wkncxrf9=sp.getAttribute('data-tleqrjrm');var n9wexh7qqkyt=sp.getAttribute('data-zrje2vik');var pqirakl=sp.getAttribute('data-vmlergaqfkwn');var mailto=uhsseen4hmx6t7(crhodiwawke,spParts[0].length);var user=uhsseen4hmx6t7(fxs7wkncxrf9,spParts[1].length);var domainBase=uhsseen4hmx6t7(n9wexh7qqkyt,lnkParts[0].length);var tld=uhsseen4hmx6t7(pqirakl,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function kyzhn4ymzax9ipav(){var els=document.querySelectorAll('a.kizaatnj-tmnzr0im');var handler=function(){var sp=this.querySelector('span.ms2e0ooczb2ligskj-tt1tzt3j5krfh7vr');if(sp&&!this.dataset.d){var val=frd9ou8an6(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',kyzhn4ymzax9ipav);}else{kyzhn4ymzax9ipav();}})();</script>{:/nomarkdown}<a href="#" class="kizaatnj-tmnzr0im"><span class="ms2e0ooczb2ligskj-tt1tzt3j5krfh7vr" data-f2h9yjm8i1l="drzckf" data-tleqrjrm="HUTQSJUT" data-zrje2vik="xzwbwvuiqt" data-vmlergaqfkwn="kwu">XXXXXXXXXXXXXXXX</span></a>
