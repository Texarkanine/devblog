...
Like this: {::nomarkdown}<style>span.hskxwywgkeoou-yqwcu0jvjekj181m { display: inline-block; }</style><script>(function(){function wt0srbgbnnjofm6b(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function o9oi0g9x(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var up3tkivfuts=sp.getAttribute('data-jddlldn1');var cu4vu3cvmdg=sp.getAttribute('data-d2jkwlsl');var i4ftv6wnjs=sp.getAttribute('data-rhlo8dgw6');var hvopl3k=sp.getAttribute('data-zmojq0n');var mailto=wt0srbgbnnjofm6b(up3tkivfuts,spParts[0].length);var user=wt0srbgbnnjofm6b(cu4vu3cvmdg,spParts[1].length);var domainBase=wt0srbgbnnjofm6b(i4ftv6wnjs,lnkParts[0].length);var tld=wt0srbgbnnjofm6b(hvopl3k,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function xjyjvb2ihk93uk(){var els=document.querySelectorAll('a.krzy0c-tku4yv9hvd');var handler=function(){var sp=this.querySelector('span.hskxwywgkeoou-yqwcu0jvjekj181m');if(sp&&!this.dataset.d){var val=o9oi0g9x(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',xjyjvb2ihk93uk);}else{xjyjvb2ihk93uk();}})();</script>{:/nomarkdown}<a href="#" class="krzy0c-tku4yv9hvd"><span class="hskxwywgkeoou-yqwcu0jvjekj181m" data-jddlldn1="znvygb" data-d2jkwlsl="HUTQSJUT" data-rhlo8dgw6="vxuzutsgor" data-zmojq0n="myw">XXXXXXXXXXXXXXXX</span></a>
