...
Like this: {::nomarkdown}<style>span.yftsoh-okqipipclcyr42my { display: inline-block; }</style><script>(function(){function lcrlx0sym(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function bl8i1e96(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var gnoisplbw=sp.getAttribute('data-l1tqlcg');var d5jnpdhzf=sp.getAttribute('data-ylsu0nmhd');var sttfb0dc=sp.getAttribute('data-hte4hjqqe');var bbxgrj=sp.getAttribute('data-jpvadpwddhgd');var mailto=lcrlx0sym(gnoisplbw,spParts[0].length);var user=lcrlx0sym(d5jnpdhzf,spParts[1].length);var domainBase=lcrlx0sym(sttfb0dc,lnkParts[0].length);var tld=lcrlx0sym(bbxgrj,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function ioacrxryyecpn(){var els=document.querySelectorAll('a.hkdnxfpxj-kjiwvlvrvhp5q');var handler=function(){var sp=this.querySelector('span.yftsoh-okqipipclcyr42my');if(sp&&!this.dataset.d){var val=bl8i1e96(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',ioacrxryyecpn);}else{ioacrxryyecpn();}})();</script>{:/nomarkdown}<a href="#" class="hkdnxfpxj-kjiwvlvrvhp5q"><span class="yftsoh-okqipipclcyr42my" data-l1tqlcg="sgorzu" data-ylsu0nmhd="HUTQSJUT" data-hte4hjqqe="yaxcxwvjru" data-jpvadpwddhgd="pbz">XXXXXXXXXXXXXXXX</span></a>
