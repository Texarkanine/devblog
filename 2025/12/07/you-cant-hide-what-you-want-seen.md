...
Like this: {::nomarkdown}<style>span.vzqr9x07r-zrzzsbvw90l { display: inline-block; }</style><script>(function(){function s5lky73lp(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function g0ibb5q07viw5(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var wayaj9cc5d=sp.getAttribute('data-ydixz3d');var hrrdwwdyx=sp.getAttribute('data-sd54eh9');var se4axwjmnn=sp.getAttribute('data-ughjav');var zj2hyv=sp.getAttribute('data-pni1wggfg');var mailto=s5lky73lp(wayaj9cc5d,spParts[0].length);var user=s5lky73lp(hrrdwwdyx,spParts[1].length);var domainBase=s5lky73lp(se4axwjmnn,lnkParts[0].length);var tld=s5lky73lp(zj2hyv,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function qhi7yevw5tv4agl7(){var els=document.querySelectorAll('a.euzhpz6r-myfhbwb6gwi');var handler=function(){var sp=this.querySelector('span.vzqr9x07r-zrzzsbvw90l');if(sp&&!this.dataset.d){var val=g0ibb5q07viw5(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',qhi7yevw5tv4agl7);}else{qhi7yevw5tv4agl7();}})();</script>{:/nomarkdown}<a href="#" class="euzhpz6r-myfhbwb6gwi"><span class="vzqr9x07r-zrzzsbvw90l" data-ydixz3d="vjrucx" data-sd54eh9="CPOLNEPO" data-ughjav="xzwbwvuiqt" data-pni1wggfg="nzx">XXXXXXXXXXXXXXXX</span></a>
