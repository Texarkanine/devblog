...
Like this: {::nomarkdown}<style>span.dgon3qj9qzh5jbsp-pt3xni4w { display: inline-block; }</style><script>(function(){function tcx3euubh0qgw(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function e6nd26yekctekcsf(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var pc4frjwcypmf=sp.getAttribute('data-x1nrmjgx');var yt8w09=sp.getAttribute('data-hssovulv');var lu9b7god=sp.getAttribute('data-riz0e5xx');var gm9liy8hhg=sp.getAttribute('data-ovsrf4tm');var mailto=tcx3euubh0qgw(pc4frjwcypmf,spParts[0].length);var user=tcx3euubh0qgw(yt8w09,spParts[1].length);var domainBase=tcx3euubh0qgw(lu9b7god,lnkParts[0].length);var tld=tcx3euubh0qgw(gm9liy8hhg,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function t1qasvcm(){var els=document.querySelectorAll('a.da1sv0m-vd87ozf6r4x9v6');var handler=function(){var sp=this.querySelector('span.dgon3qj9qzh5jbsp-pt3xni4w');if(sp&&!this.dataset.d){var val=e6nd26yekctekcsf(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',t1qasvcm);}else{t1qasvcm();}})();</script>{:/nomarkdown}<a href="#" class="da1sv0m-vd87ozf6r4x9v6"><span class="dgon3qj9qzh5jbsp-pt3xni4w" data-x1nrmjgx="cqybje" data-hssovulv="ZMLIKBML" data-riz0e5xx="wyvavuthps" data-ovsrf4tm="qca">XXXXXXXXXXXXXXXX</span></a>
