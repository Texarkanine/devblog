...
Like this: {::nomarkdown}<style>span.a1yk-zlhoyqb { display: inline-block; }</style><script>(function(){function oyt2ejixcciflhs(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function gaqj9mxb5khgxh(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var hltvsg0z=sp.getAttribute('data-zfwkeh');var xjjqk1=sp.getAttribute('data-n7lzsqb572o');var oficxxbplh=sp.getAttribute('data-mpsuxg');var mqliohu8e9=sp.getAttribute('data-vszwskazrio');var mailto=oyt2ejixcciflhs(hltvsg0z,spParts[0].length);var user=oyt2ejixcciflhs(xjjqk1,spParts[1].length);var domainBase=oyt2ejixcciflhs(oficxxbplh,lnkParts[0].length);var tld=oyt2ejixcciflhs(mqliohu8e9,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function o9tfic7qv(){var els=document.querySelectorAll('a.dcyroptomsqtnjrm-bqrq7g17na');var handler=function(){var sp=this.querySelector('span.a1yk-zlhoyqb');if(sp&&!this.dataset.d){var val=gaqj9mxb5khgxh(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',o9tfic7qv);}else{o9tfic7qv();}})();</script>{:/nomarkdown}<a href="#" class="dcyroptomsqtnjrm-bqrq7g17na"><span class="a1yk-zlhoyqb" data-zfwkeh="qempxs" data-n7lzsqb572o="YLKHJALK" data-mpsuxg="fhejedcqyb" data-vszwskazrio="myw">XXXXXXXXXXXXXXXX</span></a>
