...
Like this: {::nomarkdown}<style>span.sjj6ltfs-mlxjmylmr { display: inline-block; }</style><script>(function(){function agzezjpkyoh9bseq(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function n9ajz6luliu(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var aaov6u10=sp.getAttribute('data-rszzgz');var hahqx0fmxn=sp.getAttribute('data-l2niqmq');var ejzmm0gmvv=sp.getAttribute('data-xakxbshipc');var vvv8l2ijdrcr=sp.getAttribute('data-uoajttlh7');var mailto=agzezjpkyoh9bseq(aaov6u10,spParts[0].length);var user=agzezjpkyoh9bseq(hahqx0fmxn,spParts[1].length);var domainBase=agzezjpkyoh9bseq(ejzmm0gmvv,lnkParts[0].length);var tld=agzezjpkyoh9bseq(vvv8l2ijdrcr,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function slgmt2pkchtn0z83(){var els=document.querySelectorAll('a.wuo8bioxv0x8rrt9-hwhk8wzj1');var handler=function(){var sp=this.querySelector('span.sjj6ltfs-mlxjmylmr');if(sp&&!this.dataset.d){var val=n9ajz6luliu(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',slgmt2pkchtn0z83);}else{slgmt2pkchtn0z83();}})();</script>{:/nomarkdown}<a href="#" class="wuo8bioxv0x8rrt9-hwhk8wzj1"><span class="sjj6ltfs-mlxjmylmr" data-rszzgz="uiqtbw" data-l2niqmq="ANMJLCNM" data-xakxbshipc="fhejedcqyb" data-uoajttlh7="lxv">XXXXXXXXXXXXXXXX</span></a>
