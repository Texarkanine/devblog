...
Like this: {::nomarkdown}<style>span.kseqfsuytd83i5tn-tjkszspm { display: inline-block; }</style><script>(function(){function nohevyc052m(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function zotcfgj49wlvs(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var mp86oa0x3jqx=sp.getAttribute('data-t4r6xqzy');var my1tupoafz=sp.getAttribute('data-qew3cgwvap');var gz9nb1dhcf=sp.getAttribute('data-sbk0itks');var dikmad=sp.getAttribute('data-khdoblhybv');var mailto=nohevyc052m(mp86oa0x3jqx,spParts[0].length);var user=nohevyc052m(my1tupoafz,spParts[1].length);var domainBase=nohevyc052m(gz9nb1dhcf,lnkParts[0].length);var tld=nohevyc052m(dikmad,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function qyqvywduuan(){var els=document.querySelectorAll('a.kjdl-vxckkjnku');var handler=function(){var sp=this.querySelector('span.kseqfsuytd83i5tn-tjkszspm');if(sp&&!this.dataset.d){var val=zotcfgj49wlvs(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',qyqvywduuan);}else{qyqvywduuan();}})();</script>{:/nomarkdown}<a href="#" class="kjdl-vxckkjnku"><span class="kseqfsuytd83i5tn-tjkszspm" data-t4r6xqzy="cqybje" data-qew3cgwvap="ZMLIKBML" data-sbk0itks="tvsxsrqemp" data-khdoblhybv="lxv">XXXXXXXXXXXXXXXX</span></a>
