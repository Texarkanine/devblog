...
Like this: {::nomarkdown}<style>span.tvxxwlbrr-oq4r9o { display: inline-block; }</style><script>(function(){function atoevi2odsxorb(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function bosnbnwueylbt(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var qj0sa2w=sp.getAttribute('data-sll6yd0jixi');var rxg1wd=sp.getAttribute('data-pxneg3z6tbmh');var vlwe97nj7=sp.getAttribute('data-xm8ic2fhm');var pnkknli3pi=sp.getAttribute('data-gzy33prv8');var mailto=atoevi2odsxorb(qj0sa2w,spParts[0].length);var user=atoevi2odsxorb(rxg1wd,spParts[1].length);var domainBase=atoevi2odsxorb(vlwe97nj7,lnkParts[0].length);var tld=atoevi2odsxorb(pnkknli3pi,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function jvbthyabgochnqrf(){var els=document.querySelectorAll('a.f3x18m08sdvnj-zksos1g6c1mef');var handler=function(){var sp=this.querySelector('span.tvxxwlbrr-oq4r9o');if(sp&&!this.dataset.d){var val=bosnbnwueylbt(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',jvbthyabgochnqrf);}else{jvbthyabgochnqrf();}})();</script>{:/nomarkdown}<a href="#" class="f3x18m08sdvnj-zksos1g6c1mef"><span class="tvxxwlbrr-oq4r9o" data-sll6yd0jixi="vjrucx" data-pxneg3z6tbmh="XKJGIZKJ" data-xm8ic2fhm="cebgbaznvy" data-gzy33prv8="pbz">XXXXXXXXXXXXXXXX</span></a>
