...
Like this: {::nomarkdown}<style>span.z3us17qz-gr5dqgvydrj6mu { display: inline-block; }</style><script>(function(){function eummgzdey14(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function yvezbzfq(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var w4orcu0t=sp.getAttribute('data-flq8qh');var hwhmlfllexe=sp.getAttribute('data-gse3f4h');var izbvl70ol=sp.getAttribute('data-ilwsqjbopz');var fd6i0h1wu3l=sp.getAttribute('data-mi13ztfj');var mailto=eummgzdey14(w4orcu0t,spParts[0].length);var user=eummgzdey14(hwhmlfllexe,spParts[1].length);var domainBase=eummgzdey14(izbvl70ol,lnkParts[0].length);var tld=eummgzdey14(fd6i0h1wu3l,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function h25ce1ugej0km84l(){var els=document.querySelectorAll('a.zo83ggjfdl6-vvjpcev');var handler=function(){var sp=this.querySelector('span.z3us17qz-gr5dqgvydrj6mu');if(sp&&!this.dataset.d){var val=yvezbzfq(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',h25ce1ugej0km84l);}else{h25ce1ugej0km84l();}})();</script>{:/nomarkdown}<a href="#" class="zo83ggjfdl6-vvjpcev"><span class="z3us17qz-gr5dqgvydrj6mu" data-flq8qh="uiqtbw" data-gse3f4h="FSROQHSR" data-ilwsqjbopz="aczezyxltw" data-mi13ztfj="jvt">XXXXXXXXXXXXXXXX</span></a>
