...
Like this: {::nomarkdown}<style>span.t2vaimhyy-oqyk { display: inline-block; }</style><script>(function(){function gxe0gwvvjz(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function hb0dzycw9(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var vmgrxg9cs=sp.getAttribute('data-myr7ivl7');var jub0ptrrurds=sp.getAttribute('data-l0a5sjigrsez');var i396mt0c2=sp.getAttribute('data-nnc7qmes3u');var dw1e9aeiuu=sp.getAttribute('data-tcxtzqp');var mailto=gxe0gwvvjz(vmgrxg9cs,spParts[0].length);var user=gxe0gwvvjz(jub0ptrrurds,spParts[1].length);var domainBase=gxe0gwvvjz(i396mt0c2,lnkParts[0].length);var tld=gxe0gwvvjz(dw1e9aeiuu,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function t30dc6aodwa(){var els=document.querySelectorAll('a.x4sndy5lqpaks-ba1jc3iznvgj');var handler=function(){var sp=this.querySelector('span.t2vaimhyy-oqyk');if(sp&&!this.dataset.d){var val=hb0dzycw9(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',t30dc6aodwa);}else{t30dc6aodwa();}})();</script>{:/nomarkdown}<a href="#" class="x4sndy5lqpaks-ba1jc3iznvgj"><span class="t2vaimhyy-oqyk" data-myr7ivl7="vjrucx" data-l0a5sjigrsez="VIHEGXIH" data-nnc7qmes3u="cebgbaznvy" data-tcxtzqp="oay">XXXXXXXXXXXXXXXX</span></a>
