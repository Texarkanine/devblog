...
Like this: {::nomarkdown}<style>span.ogi9rx3saaelhdx-tcmj2xpnbm { display: inline-block; }</style><script>(function(){function j8yuakl9yjg0gmws(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function czrmyog4374bcs4(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var qzr9a0c7=sp.getAttribute('data-uajx5k');var bs7k40on0ujg=sp.getAttribute('data-jxu89yqgq');var dntjnhd=sp.getAttribute('data-regjxhhzk');var e6y2zvuukeuu=sp.getAttribute('data-gtoul9mlk');var mailto=j8yuakl9yjg0gmws(qzr9a0c7,spParts[0].length);var user=j8yuakl9yjg0gmws(bs7k40on0ujg,spParts[1].length);var domainBase=j8yuakl9yjg0gmws(dntjnhd,lnkParts[0].length);var tld=j8yuakl9yjg0gmws(e6y2zvuukeuu,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function yomh5llkb(){var els=document.querySelectorAll('a.m9dmgpcxz-kxj5dzrw');var handler=function(){var sp=this.querySelector('span.ogi9rx3saaelhdx-tcmj2xpnbm');if(sp&&!this.dataset.d){var val=czrmyog4374bcs4(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',yomh5llkb);}else{yomh5llkb();}})();</script>{:/nomarkdown}<a href="#" class="m9dmgpcxz-kxj5dzrw"><span class="ogi9rx3saaelhdx-tcmj2xpnbm" data-uajx5k="bpxaid" data-jxu89yqgq="BONKMDON" data-regjxhhzk="yaxcxwvjru" data-gtoul9mlk="kwu">XXXXXXXXXXXXXXXX</span></a>
