...
Like this: {::nomarkdown}<style>span.bghkhxtjx-ogqsoakkpnhqof5 { display: inline-block; }</style><script>(function(){function etkyvlureuoup(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function j1fx7mhoqf(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var vwqbuuqg55xf=sp.getAttribute('data-qih37hfdm6z');var q3dsrztyod=sp.getAttribute('data-ksyge3x1xy9u');var s6gyxiwn=sp.getAttribute('data-msnqvw');var sybdlnccmtf=sp.getAttribute('data-zlhqn0f');var mailto=etkyvlureuoup(vwqbuuqg55xf,spParts[0].length);var user=etkyvlureuoup(q3dsrztyod,spParts[1].length);var domainBase=etkyvlureuoup(s6gyxiwn,lnkParts[0].length);var tld=etkyvlureuoup(sybdlnccmtf,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function jwsfkjdqzs(){var els=document.querySelectorAll('a.pilu96u05e3m-xd6m');var handler=function(){var sp=this.querySelector('span.bghkhxtjx-ogqsoakkpnhqof5');if(sp&&!this.dataset.d){var val=j1fx7mhoqf(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',jwsfkjdqzs);}else{jwsfkjdqzs();}})();</script>{:/nomarkdown}<a href="#" class="pilu96u05e3m-xd6m"><span class="bghkhxtjx-ogqsoakkpnhqof5" data-qih37hfdm6z="vjrucx" data-ksyge3x1xy9u="GTSPRITS" data-msnqvw="bdafazymux" data-zlhqn0f="gsq">XXXXXXXXXXXXXXXX</span></a>
