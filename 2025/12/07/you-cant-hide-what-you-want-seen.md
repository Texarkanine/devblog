...
Like this: {::nomarkdown}<style>span.ymbbxf4im-aox2tpkkfmca { display: inline-block; }</style><script>(function(){function awyakcgf(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function cx4mspapfp(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var berid0ngmcx1=sp.getAttribute('data-gnsasxh3');var rik59sz=sp.getAttribute('data-tucsj2');var o3jwmjg=sp.getAttribute('data-un1mbf');var omchtfinv4su=sp.getAttribute('data-tj0ajjjomgz');var mailto=awyakcgf(berid0ngmcx1,spParts[0].length);var user=awyakcgf(rik59sz,spParts[1].length);var domainBase=awyakcgf(o3jwmjg,lnkParts[0].length);var tld=awyakcgf(omchtfinv4su,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function wa2mbeacf(){var els=document.querySelectorAll('a.zpqbioljgmu2yrudo-edwjx2rig3p4');var handler=function(){var sp=this.querySelector('span.ymbbxf4im-aox2tpkkfmca');if(sp&&!this.dataset.d){var val=cx4mspapfp(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',wa2mbeacf);}else{wa2mbeacf();}})();</script>{:/nomarkdown}<a href="#" class="zpqbioljgmu2yrudo-edwjx2rig3p4"><span class="ymbbxf4im-aox2tpkkfmca" data-gnsasxh3="vjrucx" data-tucsj2="DQPMOFQP" data-un1mbf="gifkfedrzc" data-tj0ajjjomgz="oay">XXXXXXXXXXXXXXXX</span></a>
