...
Like this: {::nomarkdown}<style>span.lt55-pyd0mnttt7fzjbcnl { display: inline-block; }</style><script>(function(){function dqc2kjsh(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function tppybzlpch9zzr1j(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var xlctqh=sp.getAttribute('data-matdvgw');var fxm2za=sp.getAttribute('data-sqtl4mpruf');var bry9noogks=sp.getAttribute('data-v4vb6sdwd3');var idokbznead=sp.getAttribute('data-eosqs9l');var mailto=dqc2kjsh(xlctqh,spParts[0].length);var user=dqc2kjsh(fxm2za,spParts[1].length);var domainBase=dqc2kjsh(bry9noogks,lnkParts[0].length);var tld=dqc2kjsh(idokbznead,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function wkbxljcq9i20pkhy(){var els=document.querySelectorAll('a.wdygiw64lc-kxfbu3o');var handler=function(){var sp=this.querySelector('span.lt55-pyd0mnttt7fzjbcnl');if(sp&&!this.dataset.d){var val=tppybzlpch9zzr1j(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',wkbxljcq9i20pkhy);}else{wkbxljcq9i20pkhy();}})();</script>{:/nomarkdown}<a href="#" class="wdygiw64lc-kxfbu3o"><span class="lt55-pyd0mnttt7fzjbcnl" data-matdvgw="qempxs" data-sqtl4mpruf="IVURTKVU" data-v4vb6sdwd3="zbydyxwksv" data-eosqs9l="jvt">XXXXXXXXXXXXXXXX</span></a>
