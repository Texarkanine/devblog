...
Like this: {::nomarkdown}<style>span.wqpn1ttrgjm5n-pp6muknk4swlftmgf { display: inline-block; }</style><script>(function(){function akhnwcxce(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function o860ov2bnnlotv(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var bhdvo9=sp.getAttribute('data-o83uza');var bia99r5rqcob=sp.getAttribute('data-lrj7ptmu');var jprlnw=sp.getAttribute('data-ewhvswssk');var k3qnmjm5m=sp.getAttribute('data-yn9rptomht5');var mailto=akhnwcxce(bhdvo9,spParts[0].length);var user=akhnwcxce(bia99r5rqcob,spParts[1].length);var domainBase=akhnwcxce(jprlnw,lnkParts[0].length);var tld=akhnwcxce(k3qnmjm5m,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function a42ef7xxij0ar88(){var els=document.querySelectorAll('a.txwpeevgyxpoadstp-hmwagelc75ddyb');var handler=function(){var sp=this.querySelector('span.wqpn1ttrgjm5n-pp6muknk4swlftmgf');if(sp&&!this.dataset.d){var val=o860ov2bnnlotv(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',a42ef7xxij0ar88);}else{a42ef7xxij0ar88();}})();</script>{:/nomarkdown}<a href="#" class="txwpeevgyxpoadstp-hmwagelc75ddyb"><span class="wqpn1ttrgjm5n-pp6muknk4swlftmgf" data-o83uza="znvygb" data-lrj7ptmu="IVURTKVU" data-ewhvswssk="gifkfedrzc" data-yn9rptomht5="qca">XXXXXXXXXXXXXXXX</span></a>
