...
Like this: {::nomarkdown}<style>span.v5nxso-iodujdvljo { display: inline-block; }</style><script>(function(){function p9efbdtxl05k(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function dqdilgiskxbd2(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var drhb07p3wd3=sp.getAttribute('data-ejimcqi');var ctxblo7lce5=sp.getAttribute('data-l0m9zu');var fguxmn=sp.getAttribute('data-uvnpudg2q');var gsnrwbsvxgr=sp.getAttribute('data-tyxppuukqf');var mailto=p9efbdtxl05k(drhb07p3wd3,spParts[0].length);var user=p9efbdtxl05k(ctxblo7lce5,spParts[1].length);var domainBase=p9efbdtxl05k(fguxmn,lnkParts[0].length);var tld=p9efbdtxl05k(gsnrwbsvxgr,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function kvqohouqqhh(){var els=document.querySelectorAll('a.scq01dhvel9zkmg9-coepwtx5');var handler=function(){var sp=this.querySelector('span.v5nxso-iodujdvljo');if(sp&&!this.dataset.d){var val=dqdilgiskxbd2(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',kvqohouqqhh);}else{kvqohouqqhh();}})();</script>{:/nomarkdown}<a href="#" class="scq01dhvel9zkmg9-coepwtx5"><span class="v5nxso-iodujdvljo" data-ejimcqi="sgorzu" data-l0m9zu="BONKMDON" data-uvnpudg2q="fhejedcqyb" data-tyxppuukqf="kwu">XXXXXXXXXXXXXXXX</span></a>
