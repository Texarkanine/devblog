...
Like this: {::nomarkdown}<style>span.e1nulrfai6fkt-tr0c6mhtazapgiaa { display: inline-block; }</style><script>(function(){function mjrjqcbcevnl(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function lmiidck8rc(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var okislr2s=sp.getAttribute('data-meriojimy');var ha41j173m=sp.getAttribute('data-awn6xsd2');var tka9x9l=sp.getAttribute('data-qucgakdjeyfo');var bopkyze9b=sp.getAttribute('data-fkpe4feso');var mailto=mjrjqcbcevnl(okislr2s,spParts[0].length);var user=mjrjqcbcevnl(ha41j173m,spParts[1].length);var domainBase=mjrjqcbcevnl(tka9x9l,lnkParts[0].length);var tld=mjrjqcbcevnl(bopkyze9b,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function vfaaj73gyen0z(){var els=document.querySelectorAll('a.zhcaus75j-xhcgaxr7b7e');var handler=function(){var sp=this.querySelector('span.e1nulrfai6fkt-tr0c6mhtazapgiaa');if(sp&&!this.dataset.d){var val=lmiidck8rc(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',vfaaj73gyen0z);}else{vfaaj73gyen0z();}})();</script>{:/nomarkdown}<a href="#" class="zhcaus75j-xhcgaxr7b7e"><span class="e1nulrfai6fkt-tr0c6mhtazapgiaa" data-meriojimy="znvygb" data-awn6xsd2="HUTQSJUT" data-qucgakdjeyfo="yaxcxwvjru" data-fkpe4feso="nzx">XXXXXXXXXXXXXXXX</span></a>
