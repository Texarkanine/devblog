...
Like this: {::nomarkdown}<style>span.am3db-ghfm { display: inline-block; }</style><script>(function(){function eamtavfk1v0w(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function ytwtvraskyqgkdv(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var oblnzcwr=sp.getAttribute('data-jrhvsogfut');var emvluvgo=sp.getAttribute('data-mfcykg');var x7twf5=sp.getAttribute('data-fmnjjunvj0');var mpevwxnovg=sp.getAttribute('data-rg7esnpoxb');var mailto=eamtavfk1v0w(oblnzcwr,spParts[0].length);var user=eamtavfk1v0w(emvluvgo,spParts[1].length);var domainBase=eamtavfk1v0w(x7twf5,lnkParts[0].length);var tld=eamtavfk1v0w(mpevwxnovg,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function tlit830wo6y2dwin(){var els=document.querySelectorAll('a.mtswldxebzfl-i6bi4c');var handler=function(){var sp=this.querySelector('span.am3db-ghfm');if(sp&&!this.dataset.d){var val=ytwtvraskyqgkdv(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',tlit830wo6y2dwin);}else{tlit830wo6y2dwin();}})();</script>{:/nomarkdown}<a href="#" class="mtswldxebzfl-i6bi4c"><span class="am3db-ghfm" data-jrhvsogfut="rfnqyt" data-mfcykg="VIHEGXIH" data-fmnjjunvj0="bdafazymux" data-rg7esnpoxb="ius">XXXXXXXXXXXXXXXX</span></a>
