...
Like this: {::nomarkdown}<style>span.ge91vxno80jo-nfpeyf4hmrfpvi { display: inline-block; }</style><script>(function(){function vgu0neupegf6me3l(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function frqzupsz(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var jqd3smxzsp=sp.getAttribute('data-dts369oevnb');var eyklpwd=sp.getAttribute('data-lnuwadsw');var zinkr5=sp.getAttribute('data-ptsejrd');var tbbvwyw2=sp.getAttribute('data-aonu4qap2oq');var mailto=vgu0neupegf6me3l(jqd3smxzsp,spParts[0].length);var user=vgu0neupegf6me3l(eyklpwd,spParts[1].length);var domainBase=vgu0neupegf6me3l(zinkr5,lnkParts[0].length);var tld=vgu0neupegf6me3l(tbbvwyw2,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function oby8jtwqzvp6x(){var els=document.querySelectorAll('a.jesav0hlt7-uulzxuvymrn9gt');var handler=function(){var sp=this.querySelector('span.ge91vxno80jo-nfpeyf4hmrfpvi');if(sp&&!this.dataset.d){var val=frqzupsz(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',oby8jtwqzvp6x);}else{oby8jtwqzvp6x();}})();</script>{:/nomarkdown}<a href="#" class="jesav0hlt7-uulzxuvymrn9gt"><span class="ge91vxno80jo-nfpeyf4hmrfpvi" data-dts369oevnb="ymuxfa" data-lnuwadsw="FSROQHSR" data-ptsejrd="zbydyxwksv" data-aonu4qap2oq="qca">XXXXXXXXXXXXXXXX</span></a>
