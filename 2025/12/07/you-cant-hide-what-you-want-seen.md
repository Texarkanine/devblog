...
Like this: {::nomarkdown}<style>span.iun3rjo3amx42dn-n6ofbaj9 { display: inline-block; }</style><script>(function(){function souhzjps(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function ntiwtafk(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var nyu5pdafw=sp.getAttribute('data-mh5jed');var cngwcnosrcz5=sp.getAttribute('data-idbgt2c9');var lvwckoujhnic=sp.getAttribute('data-djwxtelc');var wualkojmhzgn=sp.getAttribute('data-yqgg49b');var mailto=souhzjps(nyu5pdafw,spParts[0].length);var user=souhzjps(cngwcnosrcz5,spParts[1].length);var domainBase=souhzjps(lvwckoujhnic,lnkParts[0].length);var tld=souhzjps(wualkojmhzgn,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function bwhjimyhy(){var els=document.querySelectorAll('a.pptciigwx-b105fu');var handler=function(){var sp=this.querySelector('span.iun3rjo3amx42dn-n6ofbaj9');if(sp&&!this.dataset.d){var val=ntiwtafk(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',bwhjimyhy);}else{bwhjimyhy();}})();</script>{:/nomarkdown}<a href="#" class="pptciigwx-b105fu"><span class="iun3rjo3amx42dn-n6ofbaj9" data-mh5jed="bpxaid" data-idbgt2c9="ZMLIKBML" data-djwxtelc="yaxcxwvjru" data-yqgg49b="ius">XXXXXXXXXXXXXXXX</span></a>
