...
Like this: {::nomarkdown}<style>span.z9w20wmx3zzzqro4o-lqd0nrcsosceib { display: inline-block; }</style><script>(function(){function eg6thqpoiagn9(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function tm8gx6ngqjoeb(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var fenaqx7bmaa=sp.getAttribute('data-hbugsn');var lnacojjwehjh=sp.getAttribute('data-kvyvbu');var t0jichsd4=sp.getAttribute('data-ohulhqvw');var gw0cqv0cutob=sp.getAttribute('data-wazokjnvb');var mailto=eg6thqpoiagn9(fenaqx7bmaa,spParts[0].length);var user=eg6thqpoiagn9(lnacojjwehjh,spParts[1].length);var domainBase=eg6thqpoiagn9(t0jichsd4,lnkParts[0].length);var tld=eg6thqpoiagn9(gw0cqv0cutob,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function fklsaqq7vmxe0cn(){var els=document.querySelectorAll('a.cnhbggm-r6s4d8var4gy46u');var handler=function(){var sp=this.querySelector('span.z9w20wmx3zzzqro4o-lqd0nrcsosceib');if(sp&&!this.dataset.d){var val=tm8gx6ngqjoeb(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',fklsaqq7vmxe0cn);}else{fklsaqq7vmxe0cn();}})();</script>{:/nomarkdown}<a href="#" class="cnhbggm-r6s4d8var4gy46u"><span class="z9w20wmx3zzzqro4o-lqd0nrcsosceib" data-hbugsn="drzckf" data-kvyvbu="FSROQHSR" data-ohulhqvw="wyvavuthps" data-wazokjnvb="rdb">XXXXXXXXXXXXXXXX</span></a>
