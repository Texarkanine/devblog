...
Like this: {::nomarkdown}<style>span.xo3i0-jfjv { display: inline-block; }</style><script>(function(){function j3giu2udcmon(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function fjfkfntgp2uut(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var mckqxl=sp.getAttribute('data-fovn81llpmcb');var jddc3qjts1o=sp.getAttribute('data-gcdbwjt3jmg');var sscsnwsnh=sp.getAttribute('data-lwu43xupf');var zqx8qb=sp.getAttribute('data-towu4abrhnm');var mailto=j3giu2udcmon(mckqxl,spParts[0].length);var user=j3giu2udcmon(jddc3qjts1o,spParts[1].length);var domainBase=j3giu2udcmon(sscsnwsnh,lnkParts[0].length);var tld=j3giu2udcmon(zqx8qb,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function nhcsrkcsfffhz9a(){var els=document.querySelectorAll('a.jhfnxjtjmoz5yorf-pettunhdxot');var handler=function(){var sp=this.querySelector('span.xo3i0-jfjv');if(sp&&!this.dataset.d){var val=fjfkfntgp2uut(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',nhcsrkcsfffhz9a);}else{nhcsrkcsfffhz9a();}})();</script>{:/nomarkdown}<a href="#" class="jhfnxjtjmoz5yorf-pettunhdxot"><span class="xo3i0-jfjv" data-fovn81llpmcb="rfnqyt" data-gcdbwjt3jmg="VIHEGXIH" data-lwu43xupf="fhejedcqyb" data-towu4abrhnm="nzx">XXXXXXXXXXXXXXXX</span></a>
