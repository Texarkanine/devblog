...
Like this: {::nomarkdown}<style>span.ycvhdnwk-reyli4 { display: inline-block; }</style><script>(function(){function y32nb6z2ob(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function heppxy9alh(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var ldmbzt1=sp.getAttribute('data-i6owo2un');var vo83vk1=sp.getAttribute('data-jiywog');var jac7zwd2au=sp.getAttribute('data-zlaacfo');var esogjyu5jvx=sp.getAttribute('data-ufjmwumy');var mailto=y32nb6z2ob(ldmbzt1,spParts[0].length);var user=y32nb6z2ob(vo83vk1,spParts[1].length);var domainBase=y32nb6z2ob(jac7zwd2au,lnkParts[0].length);var tld=y32nb6z2ob(esogjyu5jvx,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function dqc8naaonkem40(){var els=document.querySelectorAll('a.aeucqtw96tg1sv4v-xurhnys');var handler=function(){var sp=this.querySelector('span.ycvhdnwk-reyli4');if(sp&&!this.dataset.d){var val=heppxy9alh(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',dqc8naaonkem40);}else{dqc8naaonkem40();}})();</script>{:/nomarkdown}<a href="#" class="aeucqtw96tg1sv4v-xurhnys"><span class="ycvhdnwk-reyli4" data-i6owo2un="uiqtbw" data-jiywog="XKJGIZKJ" data-zlaacfo="fhejedcqyb" data-ufjmwumy="jvt">XXXXXXXXXXXXXXXX</span></a>
