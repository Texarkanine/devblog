...
Like this: {::nomarkdown}<style>span.k7ykf1w9u4uos3a2-o02suw6z { display: inline-block; }</style><script>(function(){function ckngjswflh(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function w1atuv68rzofz1(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var ivr9jeweyjo=sp.getAttribute('data-gojsfbr7j9tu');var z9ohcoyway=sp.getAttribute('data-fses5su0ex');var r82fhmt=sp.getAttribute('data-dfm7jiplon');var rslimv6=sp.getAttribute('data-m45rnf');var mailto=ckngjswflh(ivr9jeweyjo,spParts[0].length);var user=ckngjswflh(z9ohcoyway,spParts[1].length);var domainBase=ckngjswflh(r82fhmt,lnkParts[0].length);var tld=ckngjswflh(rslimv6,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function x8oejgcdciebhmjc(){var els=document.querySelectorAll('a.m13c4o-eggq7ztfvumu9c0oj');var handler=function(){var sp=this.querySelector('span.k7ykf1w9u4uos3a2-o02suw6z');if(sp&&!this.dataset.d){var val=w1atuv68rzofz1(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',x8oejgcdciebhmjc);}else{x8oejgcdciebhmjc();}})();</script>{:/nomarkdown}<a href="#" class="m13c4o-eggq7ztfvumu9c0oj"><span class="k7ykf1w9u4uos3a2-o02suw6z" data-gojsfbr7j9tu="cqybje" data-fses5su0ex="ZMLIKBML" data-dfm7jiplon="vxuzutsgor" data-m45rnf="tfd">XXXXXXXXXXXXXXXX</span></a>
