...
Like this: {::nomarkdown}<style>span.ofcfyr-dg9klzzxjzv { display: inline-block; }</style><script>(function(){function ybfl36gds5yb8fhs(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function m6drqujwbybjm(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var ub48gatr=sp.getAttribute('data-ulzol4xwzh');var ax2gvkvx=sp.getAttribute('data-zqqjdfmoc5z');var onrcgj6t=sp.getAttribute('data-xjgwnnnhzuis');var bolalzgquuyu=sp.getAttribute('data-txr20hx');var mailto=ybfl36gds5yb8fhs(ub48gatr,spParts[0].length);var user=ybfl36gds5yb8fhs(ax2gvkvx,spParts[1].length);var domainBase=ybfl36gds5yb8fhs(onrcgj6t,lnkParts[0].length);var tld=ybfl36gds5yb8fhs(bolalzgquuyu,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function wmkiyfy0fqpo(){var els=document.querySelectorAll('a.f45me8-smehxixdjv0ov');var handler=function(){var sp=this.querySelector('span.ofcfyr-dg9klzzxjzv');if(sp&&!this.dataset.d){var val=m6drqujwbybjm(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',wmkiyfy0fqpo);}else{wmkiyfy0fqpo();}})();</script>{:/nomarkdown}<a href="#" class="f45me8-smehxixdjv0ov"><span class="ofcfyr-dg9klzzxjzv" data-ulzol4xwzh="sgorzu" data-zqqjdfmoc5z="CPOLNEPO" data-xjgwnnnhzuis="vxuzutsgor" data-txr20hx="pbz">XXXXXXXXXXXXXXXX</span></a>
