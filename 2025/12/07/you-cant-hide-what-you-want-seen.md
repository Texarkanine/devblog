...
Like this: {::nomarkdown}<style>span.svlfy9bdiswt-pqjewznl0mqe { display: inline-block; }</style><script>(function(){function vic9y0dv(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function u4krctoxma4njjrd(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var quc3pg=sp.getAttribute('data-wcpackcgb0');var kpjbxglamig=sp.getAttribute('data-bg9be1eu72p9');var d4qntjcxeda=sp.getAttribute('data-yszw7s');var cnxtnr=sp.getAttribute('data-rm9phtu');var mailto=vic9y0dv(quc3pg,spParts[0].length);var user=vic9y0dv(kpjbxglamig,spParts[1].length);var domainBase=vic9y0dv(d4qntjcxeda,lnkParts[0].length);var tld=vic9y0dv(cnxtnr,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function p29bkpa8piru8b(){var els=document.querySelectorAll('a.bdg7ps8fxy-dz9vvkjdzxdw4z');var handler=function(){var sp=this.querySelector('span.svlfy9bdiswt-pqjewznl0mqe');if(sp&&!this.dataset.d){var val=u4krctoxma4njjrd(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',p29bkpa8piru8b);}else{p29bkpa8piru8b();}})();</script>{:/nomarkdown}<a href="#" class="bdg7ps8fxy-dz9vvkjdzxdw4z"><span class="svlfy9bdiswt-pqjewznl0mqe" data-wcpackcgb0="ymuxfa" data-bg9be1eu72p9="DQPMOFQP" data-yszw7s="zbydyxwksv" data-rm9phtu="qca">XXXXXXXXXXXXXXXX</span></a>
