...
Like this: {::nomarkdown}<style>span.xdrmuahu-zauq4pr0wellto { display: inline-block; }</style><script>(function(){function nkpkz4b2(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function rggvzvhn0vppv(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var cv8aoneud3sr=sp.getAttribute('data-fisz0oak');var ueumf20=sp.getAttribute('data-l8u8ey3r');var kiaxi5o=sp.getAttribute('data-ch0memfpj');var uoo4nitqapw=sp.getAttribute('data-hemekk');var mailto=nkpkz4b2(cv8aoneud3sr,spParts[0].length);var user=nkpkz4b2(ueumf20,spParts[1].length);var domainBase=nkpkz4b2(kiaxi5o,lnkParts[0].length);var tld=nkpkz4b2(uoo4nitqapw,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function oexg7l7rc(){var els=document.querySelectorAll('a.ztopqhvbrdxm2-h0qrjln8ihj6o');var handler=function(){var sp=this.querySelector('span.xdrmuahu-zauq4pr0wellto');if(sp&&!this.dataset.d){var val=rggvzvhn0vppv(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',oexg7l7rc);}else{oexg7l7rc();}})();</script>{:/nomarkdown}<a href="#" class="ztopqhvbrdxm2-h0qrjln8ihj6o"><span class="xdrmuahu-zauq4pr0wellto" data-fisz0oak="uiqtbw" data-l8u8ey3r="FSROQHSR" data-ch0memfpj="cebgbaznvy" data-hemekk="pbz">XXXXXXXXXXXXXXXX</span></a>
