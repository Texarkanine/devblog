...
Like this: {::nomarkdown}<style>span.cjcbmeqsuyizou-fjvafujdmj { display: inline-block; }</style><script>(function(){function obhwhkeb(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function bgyzmob5w66ht(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var rjvfusic=sp.getAttribute('data-dgo4azyh6gr7');var hqrb6kfv=sp.getAttribute('data-hcwoskfwe');var ahpfqetyhty=sp.getAttribute('data-h7czs3qsgs');var y1gpm1qh7r=sp.getAttribute('data-wno5jz81ll');var mailto=obhwhkeb(rjvfusic,spParts[0].length);var user=obhwhkeb(hqrb6kfv,spParts[1].length);var domainBase=obhwhkeb(ahpfqetyhty,lnkParts[0].length);var tld=obhwhkeb(y1gpm1qh7r,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function ljhz1zla(){var els=document.querySelectorAll('a.rylkjmk5cvxpw-sp2shlpkd2qtszah');var handler=function(){var sp=this.querySelector('span.cjcbmeqsuyizou-fjvafujdmj');if(sp&&!this.dataset.d){var val=bgyzmob5w66ht(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',ljhz1zla);}else{ljhz1zla();}})();</script>{:/nomarkdown}<a href="#" class="rylkjmk5cvxpw-sp2shlpkd2qtszah"><span class="cjcbmeqsuyizou-fjvafujdmj" data-dgo4azyh6gr7="aowzhc" data-hcwoskfwe="BONKMDON" data-h7czs3qsgs="cebgbaznvy" data-wno5jz81ll="sec">XXXXXXXXXXXXXXXX</span></a>
