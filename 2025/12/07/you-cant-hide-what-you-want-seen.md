...
Like this: {::nomarkdown}<style>span.mt83-vf6v6jq6i { display: inline-block; }</style><script>(function(){function svyjt2vly(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function ylxfctew82(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var jjn0jvkidj=sp.getAttribute('data-vdae9trweew');var rruvs53w8bk5=sp.getAttribute('data-xr6sc5szz3f');var lqydhwaost=sp.getAttribute('data-u0aihnwph9eg');var ok9g43ery=sp.getAttribute('data-cdazhi5');var mailto=svyjt2vly(jjn0jvkidj,spParts[0].length);var user=svyjt2vly(rruvs53w8bk5,spParts[1].length);var domainBase=svyjt2vly(lqydhwaost,lnkParts[0].length);var tld=svyjt2vly(ok9g43ery,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function sgnzlibv4j(){var els=document.querySelectorAll('a.mbi1kmgn4gbl0lkhy-g1hwkwhe9cj');var handler=function(){var sp=this.querySelector('span.mt83-vf6v6jq6i');if(sp&&!this.dataset.d){var val=ylxfctew82(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',sgnzlibv4j);}else{sgnzlibv4j();}})();</script>{:/nomarkdown}<a href="#" class="mbi1kmgn4gbl0lkhy-g1hwkwhe9cj"><span class="mt83-vf6v6jq6i" data-vdae9trweew="qempxs" data-xr6sc5szz3f="ANMJLCNM" data-u0aihnwph9eg="gifkfedrzc" data-cdazhi5="nzx">XXXXXXXXXXXXXXXX</span></a>
