...
Like this: {::nomarkdown}<style>span.gbq6rhpbicpx22mcf-o0vv9m9jd { display: inline-block; }</style><script>(function(){function s1zjkxdyyz73ecp(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function mszgtgaryyg(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var gtkvgub3wok=sp.getAttribute('data-nbilgqzufzpw');var qvvzbffv=sp.getAttribute('data-kgapu3');var wsxaakg8a=sp.getAttribute('data-fat2aawr6wuj');var utuazq4bs=sp.getAttribute('data-v4nuv63');var mailto=s1zjkxdyyz73ecp(gtkvgub3wok,spParts[0].length);var user=s1zjkxdyyz73ecp(qvvzbffv,spParts[1].length);var domainBase=s1zjkxdyyz73ecp(wsxaakg8a,lnkParts[0].length);var tld=s1zjkxdyyz73ecp(utuazq4bs,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function bqen89xqkh06bm(){var els=document.querySelectorAll('a.yfo3t2oo3mkjayakk-vuuhvladyg');var handler=function(){var sp=this.querySelector('span.gbq6rhpbicpx22mcf-o0vv9m9jd');if(sp&&!this.dataset.d){var val=mszgtgaryyg(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',bqen89xqkh06bm);}else{bqen89xqkh06bm();}})();</script>{:/nomarkdown}<a href="#" class="yfo3t2oo3mkjayakk-vuuhvladyg"><span class="gbq6rhpbicpx22mcf-o0vv9m9jd" data-nbilgqzufzpw="drzckf" data-kgapu3="ANMJLCNM" data-fat2aawr6wuj="gifkfedrzc" data-v4nuv63="myw">XXXXXXXXXXXXXXXX</span></a>
