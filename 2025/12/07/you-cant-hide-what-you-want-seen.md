...
Like this: {::nomarkdown}<style>span.e03dr05-teigedaxk5hvukcg { display: inline-block; }</style><script>(function(){function bmnntvje8zvbpr(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function jpt831tfx6r(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var uxf6iwo=sp.getAttribute('data-zo540qa9');var dcv9jmn2fxp=sp.getAttribute('data-mvraegcv2l');var asom9ti=sp.getAttribute('data-bvxti4kyom');var y0hgxnarm4z8=sp.getAttribute('data-tfa567l1');var mailto=bmnntvje8zvbpr(uxf6iwo,spParts[0].length);var user=bmnntvje8zvbpr(dcv9jmn2fxp,spParts[1].length);var domainBase=bmnntvje8zvbpr(asom9ti,lnkParts[0].length);var tld=bmnntvje8zvbpr(y0hgxnarm4z8,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function tqallb0eyk(){var els=document.querySelectorAll('a.ui9rg0vc-vyfooqt5w5gjsi');var handler=function(){var sp=this.querySelector('span.e03dr05-teigedaxk5hvukcg');if(sp&&!this.dataset.d){var val=jpt831tfx6r(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',tqallb0eyk);}else{tqallb0eyk();}})();</script>{:/nomarkdown}<a href="#" class="ui9rg0vc-vyfooqt5w5gjsi"><span class="e03dr05-teigedaxk5hvukcg" data-zo540qa9="thpsav" data-mvraegcv2l="HUTQSJUT" data-bvxti4kyom="xzwbwvuiqt" data-tfa567l1="qca">XXXXXXXXXXXXXXXX</span></a>
