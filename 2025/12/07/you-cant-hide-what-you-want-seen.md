...
Like this: {::nomarkdown}<style>span.yungj-kguxvfkgcx0xb3mo { display: inline-block; }</style><script>(function(){function lyig1dfrzga4dqvd(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function m9eotnir7v(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var fucylif=sp.getAttribute('data-qtvlzwxsh');var xwjq9d=sp.getAttribute('data-s2g1wtvo');var vh7o62qesx=sp.getAttribute('data-ba6ya7m');var ynkpot=sp.getAttribute('data-kkpikfuk');var mailto=lyig1dfrzga4dqvd(fucylif,spParts[0].length);var user=lyig1dfrzga4dqvd(xwjq9d,spParts[1].length);var domainBase=lyig1dfrzga4dqvd(vh7o62qesx,lnkParts[0].length);var tld=lyig1dfrzga4dqvd(ynkpot,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function fdh4lendivw(){var els=document.querySelectorAll('a.haawkf1vpx-qg0fj8aswvceoce4i');var handler=function(){var sp=this.querySelector('span.yungj-kguxvfkgcx0xb3mo');if(sp&&!this.dataset.d){var val=m9eotnir7v(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',fdh4lendivw);}else{fdh4lendivw();}})();</script>{:/nomarkdown}<a href="#" class="haawkf1vpx-qg0fj8aswvceoce4i"><span class="yungj-kguxvfkgcx0xb3mo" data-qtvlzwxsh="rfnqyt" data-s2g1wtvo="HUTQSJUT" data-ba6ya7m="zbydyxwksv" data-kkpikfuk="tfd">XXXXXXXXXXXXXXXX</span></a>
