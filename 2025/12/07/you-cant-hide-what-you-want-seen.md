...
Like this: {::nomarkdown}<style>span.embl6f5ucgeodw5-rbnnkqx1ddgjvizk { display: inline-block; }</style><script>(function(){function epalcg5eujptfut(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function tjepe1zikzc3xh9c(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var xwcrpkopkf=sp.getAttribute('data-luceypn1cqxh');var dozopg=sp.getAttribute('data-l65yf4ojnggi');var hmotdrxk=sp.getAttribute('data-wvphnnxidsid');var sakkrgk4tf=sp.getAttribute('data-urdirjhvnfoy');var mailto=epalcg5eujptfut(xwcrpkopkf,spParts[0].length);var user=epalcg5eujptfut(dozopg,spParts[1].length);var domainBase=epalcg5eujptfut(hmotdrxk,lnkParts[0].length);var tld=epalcg5eujptfut(sakkrgk4tf,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function b7tletm51qs9qqb8(){var els=document.querySelectorAll('a.grkr04soveifqcaz-vpixj');var handler=function(){var sp=this.querySelector('span.embl6f5ucgeodw5-rbnnkqx1ddgjvizk');if(sp&&!this.dataset.d){var val=tjepe1zikzc3xh9c(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',b7tletm51qs9qqb8);}else{b7tletm51qs9qqb8();}})();</script>{:/nomarkdown}<a href="#" class="grkr04soveifqcaz-vpixj"><span class="embl6f5ucgeodw5-rbnnkqx1ddgjvizk" data-luceypn1cqxh="bpxaid" data-l65yf4ojnggi="HUTQSJUT" data-wvphnnxidsid="fhejedcqyb" data-urdirjhvnfoy="htr">XXXXXXXXXXXXXXXX</span></a>
