...
Like this: {::nomarkdown}<style>span.eryr6emfkhlunzz-mhlujapiy54dizr { display: inline-block; }</style><script>(function(){function ayeobtz19mriu(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function yhlxlybg(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var fn4vpmodxj=sp.getAttribute('data-imllth9bhllz');var rcs7kw4k8l=sp.getAttribute('data-hlt5kivqwcp');var l2gegllxqjtv=sp.getAttribute('data-enplruwozgkf');var zopja3rojdp=sp.getAttribute('data-yvmtdz');var mailto=ayeobtz19mriu(fn4vpmodxj,spParts[0].length);var user=ayeobtz19mriu(rcs7kw4k8l,spParts[1].length);var domainBase=ayeobtz19mriu(l2gegllxqjtv,lnkParts[0].length);var tld=ayeobtz19mriu(zopja3rojdp,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function op41bdgb(){var els=document.querySelectorAll('a.kflprmm5-ebg1uecgwkn');var handler=function(){var sp=this.querySelector('span.eryr6emfkhlunzz-mhlujapiy54dizr');if(sp&&!this.dataset.d){var val=yhlxlybg(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',op41bdgb);}else{op41bdgb();}})();</script>{:/nomarkdown}<a href="#" class="kflprmm5-ebg1uecgwkn"><span class="eryr6emfkhlunzz-mhlujapiy54dizr" data-imllth9bhllz="bpxaid" data-hlt5kivqwcp="GTSPRITS" data-enplruwozgkf="xzwbwvuiqt" data-yvmtdz="nzx">XXXXXXXXXXXXXXXX</span></a>
