...
Like this: {::nomarkdown}<style>span.g6grb2a7wv9mk-zwib { display: inline-block; }</style><script>(function(){function oihyndtvdxq(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function dwkw48qe06llw(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var tbfxbbb=sp.getAttribute('data-f3mbqvx');var k51g6o4=sp.getAttribute('data-h6ye9csyeb');var ikuvc40hl=sp.getAttribute('data-x9hnzp');var h50wnrd=sp.getAttribute('data-mdtbrdg');var mailto=oihyndtvdxq(tbfxbbb,spParts[0].length);var user=oihyndtvdxq(k51g6o4,spParts[1].length);var domainBase=oihyndtvdxq(ikuvc40hl,lnkParts[0].length);var tld=oihyndtvdxq(h50wnrd,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function sfdqdhksce5(){var els=document.querySelectorAll('a.f9k20ik0gpjpq4kgi-lfkpkx6beovbt');var handler=function(){var sp=this.querySelector('span.g6grb2a7wv9mk-zwib');if(sp&&!this.dataset.d){var val=dwkw48qe06llw(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',sfdqdhksce5);}else{sfdqdhksce5();}})();</script>{:/nomarkdown}<a href="#" class="f9k20ik0gpjpq4kgi-lfkpkx6beovbt"><span class="g6grb2a7wv9mk-zwib" data-f3mbqvx="znvygb" data-h6ye9csyeb="VIHEGXIH" data-x9hnzp="gifkfedrzc" data-mdtbrdg="pbz">XXXXXXXXXXXXXXXX</span></a>
