...
Like this: {::nomarkdown}<style>span.t6tgcwsbid-xtucvhztx6fv3gu { display: inline-block; }</style><script>(function(){function stlgue6hnwwcqx1t(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function pfnpqnwfpz5dyc(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var jtpscavxpnmo=sp.getAttribute('data-vzgiytcdw');var cnqjs7a=sp.getAttribute('data-ylmafwtdcmqb');var ifokfun=sp.getAttribute('data-hf8i2im');var sihp93=sp.getAttribute('data-ylikytvxo97');var mailto=stlgue6hnwwcqx1t(jtpscavxpnmo,spParts[0].length);var user=stlgue6hnwwcqx1t(cnqjs7a,spParts[1].length);var domainBase=stlgue6hnwwcqx1t(ifokfun,lnkParts[0].length);var tld=stlgue6hnwwcqx1t(sihp93,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function kglzqx2j(){var els=document.querySelectorAll('a.ut9gmcxvp-fp7edkavxabb');var handler=function(){var sp=this.querySelector('span.t6tgcwsbid-xtucvhztx6fv3gu');if(sp&&!this.dataset.d){var val=pfnpqnwfpz5dyc(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',kglzqx2j);}else{kglzqx2j();}})();</script>{:/nomarkdown}<a href="#" class="ut9gmcxvp-fp7edkavxabb"><span class="t6tgcwsbid-xtucvhztx6fv3gu" data-vzgiytcdw="wksvdy" data-ylmafwtdcmqb="GTSPRITS" data-hf8i2im="yaxcxwvjru" data-ylikytvxo97="oay">XXXXXXXXXXXXXXXX</span></a>
