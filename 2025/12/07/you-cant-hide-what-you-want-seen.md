...
Like this: {::nomarkdown}<style>span.ermyo7n24oonql5-rnlltphlf20zympar { display: inline-block; }</style><script>(function(){function h9vfcuy9f(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function pozdjlh0sooc(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var bh4r0tb=sp.getAttribute('data-av2a2efikw');var lwqdvw9xhf8=sp.getAttribute('data-xzw426q6p');var w3txwaku3k4v=sp.getAttribute('data-csfnxvbprjj');var zczmkheafkw=sp.getAttribute('data-w28ct3c');var mailto=h9vfcuy9f(bh4r0tb,spParts[0].length);var user=h9vfcuy9f(lwqdvw9xhf8,spParts[1].length);var domainBase=h9vfcuy9f(w3txwaku3k4v,lnkParts[0].length);var tld=h9vfcuy9f(zczmkheafkw,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function zidqasxps4i3(){var els=document.querySelectorAll('a.sqmiwqyuety1de3bm-aps2aws1t');var handler=function(){var sp=this.querySelector('span.ermyo7n24oonql5-rnlltphlf20zympar');if(sp&&!this.dataset.d){var val=pozdjlh0sooc(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',zidqasxps4i3);}else{zidqasxps4i3();}})();</script>{:/nomarkdown}<a href="#" class="sqmiwqyuety1de3bm-aps2aws1t"><span class="ermyo7n24oonql5-rnlltphlf20zympar" data-av2a2efikw="bpxaid" data-xzw426q6p="IVURTKVU" data-csfnxvbprjj="gifkfedrzc" data-w28ct3c="lxv">XXXXXXXXXXXXXXXX</span></a>
