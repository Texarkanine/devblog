...
Like this: {::nomarkdown}<style>span.rhlcr-jhpnjesk8 { display: inline-block; }</style><script>(function(){function aoojc9yckcc3kbkd(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function nglj4laxp4qcxqq1(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var xs4v2lrs8y=sp.getAttribute('data-tjyq88tbbn');var qogy8mxcfi=sp.getAttribute('data-rksaq2nso');var xwe6qzsuo=sp.getAttribute('data-mm6utuar');var eehubjvs9yl=sp.getAttribute('data-bqpxrhtj0uwb');var mailto=aoojc9yckcc3kbkd(xs4v2lrs8y,spParts[0].length);var user=aoojc9yckcc3kbkd(qogy8mxcfi,spParts[1].length);var domainBase=aoojc9yckcc3kbkd(xwe6qzsuo,lnkParts[0].length);var tld=aoojc9yckcc3kbkd(eehubjvs9yl,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function dxamv9uaa(){var els=document.querySelectorAll('a.njx77hlrv3geh-i0acmg');var handler=function(){var sp=this.querySelector('span.rhlcr-jhpnjesk8');if(sp&&!this.dataset.d){var val=nglj4laxp4qcxqq1(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',dxamv9uaa);}else{dxamv9uaa();}})();</script>{:/nomarkdown}<a href="#" class="njx77hlrv3geh-i0acmg"><span class="rhlcr-jhpnjesk8" data-tjyq88tbbn="rfnqyt" data-rksaq2nso="ANMJLCNM" data-mm6utuar="cebgbaznvy" data-bqpxrhtj0uwb="ius">XXXXXXXXXXXXXXXX</span></a>
