...
Like this: {::nomarkdown}<style>span.unhuux-r1ebgxlq2vpfxy1 { display: inline-block; }</style><script>(function(){function ufuyeogw0(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function droha6okwlqlh07k(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var ikzotv=sp.getAttribute('data-i2qc100xp');var o1khshwc90m=sp.getAttribute('data-lbwugsrkcdzj');var xdhd6c=sp.getAttribute('data-o42aaa');var zskrfn0bzmoe=sp.getAttribute('data-jktug4r6yeuz');var mailto=ufuyeogw0(ikzotv,spParts[0].length);var user=ufuyeogw0(o1khshwc90m,spParts[1].length);var domainBase=ufuyeogw0(xdhd6c,lnkParts[0].length);var tld=ufuyeogw0(zskrfn0bzmoe,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function icveibh07sgofzj(){var els=document.querySelectorAll('a.l0lzbwtpv-w9uz');var handler=function(){var sp=this.querySelector('span.unhuux-r1ebgxlq2vpfxy1');if(sp&&!this.dataset.d){var val=droha6okwlqlh07k(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',icveibh07sgofzj);}else{icveibh07sgofzj();}})();</script>{:/nomarkdown}<a href="#" class="l0lzbwtpv-w9uz"><span class="unhuux-r1ebgxlq2vpfxy1" data-i2qc100xp="sgorzu" data-lbwugsrkcdzj="GTSPRITS" data-o42aaa="yaxcxwvjru" data-jktug4r6yeuz="gsq">XXXXXXXXXXXXXXXX</span></a>
