...
Like this: {::nomarkdown}<style>span.j32w48vcritiyye-szg7woly { display: inline-block; }</style><script>(function(){function etfubk5n620vsn(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function lhnqsvr58bg4y(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var lbqkxfwqjqiy=sp.getAttribute('data-mil66u');var vnmihepc4zal=sp.getAttribute('data-ctj5lkcwb6ve');var hopazvfx=sp.getAttribute('data-nmlrm6jx');var khvcxen=sp.getAttribute('data-qwuryl4gy');var mailto=etfubk5n620vsn(lbqkxfwqjqiy,spParts[0].length);var user=etfubk5n620vsn(vnmihepc4zal,spParts[1].length);var domainBase=etfubk5n620vsn(hopazvfx,lnkParts[0].length);var tld=etfubk5n620vsn(khvcxen,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function t71yrdhm4(){var els=document.querySelectorAll('a.fe7ywwtsdg1n-pt0dpmf');var handler=function(){var sp=this.querySelector('span.j32w48vcritiyye-szg7woly');if(sp&&!this.dataset.d){var val=lhnqsvr58bg4y(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',t71yrdhm4);}else{t71yrdhm4();}})();</script>{:/nomarkdown}<a href="#" class="fe7ywwtsdg1n-pt0dpmf"><span class="j32w48vcritiyye-szg7woly" data-mil66u="bpxaid" data-ctj5lkcwb6ve="ZMLIKBML" data-nmlrm6jx="bdafazymux" data-qwuryl4gy="jvt">XXXXXXXXXXXXXXXX</span></a>
