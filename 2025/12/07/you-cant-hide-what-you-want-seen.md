...
Like this: {::nomarkdown}<style>span.gs1c7uj-pkkkf { display: inline-block; }</style><script>(function(){function lc0rivzxqpoo(s,n){var r='';for(var i=0;i<s.length;i++){var c=s.charCodeAt(i);if(c>=65&&c<=90){r+=String.fromCharCode((c-65-n+26)%26+65);}else if(c>=97&&c<=122){r+=String.fromCharCode((c-97-n+26)%26+97);}else r+=s[i];}return r;}function bcbeone02nyg(sp,lnk){var spParts=sp.className.split('-');var lnkParts=lnk.className.split('-');var dgmno3qvjfax=sp.getAttribute('data-q4lelfh');var qtxxbg=sp.getAttribute('data-yccg8ah');var gnendrydle=sp.getAttribute('data-uherlxaii');var h7mix4sq22t=sp.getAttribute('data-uwl6muyyjo4');var mailto=lc0rivzxqpoo(dgmno3qvjfax,spParts[0].length);var user=lc0rivzxqpoo(qtxxbg,spParts[1].length);var domainBase=lc0rivzxqpoo(gnendrydle,lnkParts[0].length);var tld=lc0rivzxqpoo(h7mix4sq22t,lnkParts[1].length);return mailto+':'+user+'@'+domainBase+'.'+tld;}function ol8vowerb944(){var els=document.querySelectorAll('a.nggkra-l20imorkbunp3iwd');var handler=function(){var sp=this.querySelector('span.gs1c7uj-pkkkf');if(sp&&!this.dataset.d){var val=bcbeone02nyg(sp,this);this.href=val;sp.textContent=val.replace('mailto:','');this.dataset.d='1';}};for(var i=0;i<els.length;i++){els[i].addEventListener('mouseover',handler);els[i].addEventListener('focus',handler);}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',ol8vowerb944);}else{ol8vowerb944();}})();</script>{:/nomarkdown}<a href="#" class="nggkra-l20imorkbunp3iwd"><span class="gs1c7uj-pkkkf" data-q4lelfh="thpsav" data-yccg8ah="WJIFHYJI" data-uherlxaii="vxuzutsgor" data-uwl6muyyjo4="sec">XXXXXXXXXXXXXXXX</span></a>
