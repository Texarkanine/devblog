...
<a class="mermaid-diagram__light" href="/assets/svg/4c820a9e.svg"><img src="/assets/svg/4c820a9e.svg" alt="Mermaid Diagram"></a>
<a class="mermaid-diagram__dark" href="/assets/svg/4c820a9e-dark.svg"><img src="/assets/svg/4c820a9e-dark.svg" alt="Mermaid Diagram"></a>
</figure>
...
- [Stop Doing AGENTS.md](/2026/02/12/stop-doing-agents-md.html)
- [.gitignore is not .agentignore](/2026/02/22/gitignore-is-not-agentignore.html)
- [Model Context Protocol, Not Agent Context Protocol](/2026/02/23/model-context-protocol-not-agent-context-protocol.html)
- [How I Learned to Stop Coding and Love the Machine # Cursor](/garden/how-i-learned-to-stop-coding-and-love-the-machine.html#cursor)
...
> -- [The Load-Bearing Rate Limiter Was Human](/2026/02/06/the-load-bearing-rate-limiter-was-human.html)
...
[You can't overclock a human](/2026/02/06/the-load-bearing-rate-limiter-was-human.html). You've got these new tools and you will never code as fast as them, so don't try. Instead, look around.
...
<div class="polaroid-container">
  <div class="polaroid">
    <a href="adeptus-mechanicus/yegge_welcome-to-gas-town_8-stages-of-developer-evolution-to-ai.webp">
      <img src="adeptus-mechanicus/yegge_welcome-to-gas-town_8-stages-of-developer-evolution-to-ai.webp" alt="The 8 Stages of Developer Evolution to AI" class="polaroid-image">
    </a>
    <div class="polaroid-title">The 8 Stages of Developer Evolution to AI</div>
    ...
    <small class="polaroid-archive">
      ...
      (<a href="https://web.archive.org/web/20260308000000/https://steve-yegge.medium.com/welcome-to-gas-town-4f25ee16dd04" target="_blank" rel="noopener">archive</a>)
...
<div class="polaroid-container">
  <div class="polaroid">
    <a href="adeptus-mechanicus/sierpinskiloop.gif">
      <img src="adeptus-mechanicus/sierpinskiloop.gif" alt="Agents managed by agents managed by agents... managed by you" class="polaroid-image">
    </a>
    <div class="polaroid-title">Agents managed by agents managed by agents... managed by you</div>
    <div class="polaroid-link">
      
      <a href="https://bleuje.com/gifanimationsite/single/sierpinskiloop/" target="_blank" rel="noopener">bleuje.com/gifanimationsite/single/sierpinskiloop/</a>
      
    </div>
    <small class="polaroid-archive">
      
      (<a href="https://web.archive.org/web/20260801201354/https://bleuje.com/gifanimationsite/single/sierpinskiloop/" target="_blank" rel="noopener">archive</a>)
...
Programmers, historically, do not have strong management chops. The ones who do tend to go *into* management. The ones who've been writing code for a decade or two often explicitly opted out of that track. The field just showed up at their desks and told them their job is management now. No wonder they're struggling. But the fastest way to learn management is to not realize you're learning it.
...
But first, a disclaimer: The specific solution **does not matter**. Everything you read here will be obsolete in two years, [probably in one](/2026/03/09/context-to-ashes-skills-to-dust.html). But *today*, here's *a* solution that'll help you speedrun through Steve Yegge's stages and achieve a significant productivity boost with minimal skill atrophy along the way. Executed properly, that ought to give you a significant leg up on optionality as you navigate the next few years.
...
These persist across tasks. Every subsequent session starts with Niko reading these files and orienting itself. This is your [AGENTS.md but better](/2026/02/12/stop-doing-agents-md.html) - created explicitly in alignment with those best-practices.
...
The command structure itself is a disciplined loop. Close the window, open a new one, run the next command. If an attempt fails, the memory bank has the record of what was tried and what went wrong. [Niko's `/nk-refresh` command](https://github.com/Texarkanine/.cursor-rules/blob/main/rulesets/niko/skills/nk-refresh/SKILL.md) performs a systematic re-diagnosis of implementation struggles: discard previous assumptions, map the system, hypothesize broadly, investigate with evidence, then fix. You're never truly stuck because you're never more than one clean context window away from a fresh start with full history.
...
**When things go sideways.** `/nk-refresh` is for troubleshooting implementation. If Niko just can't figure out how to get something right... that's a `/nk-refresh` situation. `/nk-refresh` is special in that you usually want to use it IN the existing context, so that the full specifics of what *didn't* work are available to the troubleshooting process.
...
There was a time where the models' shortcomings made it look like we had a tooling issue. Now that the models are *capable-enough*, it's [plain to see:](/2026/03/09/context-to-ashes-skills-to-dust.html) 
