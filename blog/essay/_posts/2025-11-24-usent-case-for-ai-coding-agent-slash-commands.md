...
description: "Every slash command you'd write is better served by a Rule, Skill, Hook, or Tool that the agent picks up passively. The few apparent exceptions don't survive scrutiny."
author: texarkanine
