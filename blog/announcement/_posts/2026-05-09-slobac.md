...
{% polaroid
	slobac-tonsa-tests.png
	link="https://x.com/housecor/status/2046619506626199791"
	alt="The acceleration from AI is unbelievable..."
	size=500x
%}

This post got [somewhat clowned on](https://x.com/rfleury/status/2047002777256391026) in a lot of its interactions, and it got me thinking... I also have a couple massive AI-generated test suites that probably actually do gate quality but also are absolutely not pretty.
...
Before we jump to the interesting part, let's actually bikeshed a bit on "what makes a good test / what makes a bad test." 
I didn't just crap this together, you know! Despite referencing others' definitions and work, the "good test/bad test" determination is born out of over a decade of software engineering experience, most of it pre-Transformers - I was doing it all by hand! And the agentic workflow, well that's built [on a lot of first-hand experience](/tags/harness-engineering), too.
